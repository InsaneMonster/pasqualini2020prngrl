...
def run(workspace: str,
    ...
    append_sequence_size: int = 2
    max_moves: int = 100
    environment_l1: RNGAppendDiscreteEnvironment = RNGAppendDiscreteEnvironment("rngad_2_env_l1", append_sequence_size, max_moves,
                                                                                lambda_parameter=1.0)
    # environment_l10: RNGAppendDiscreteEnvironment = RNGAppendDiscreteEnvironment("rngad_2_env_l10", append_sequence_size, max_moves,
    #                                                                              lambda_parameter=10.0)
    # environment_l25: RNGAppendDiscreteEnvironment = RNGAppendDiscreteEnvironment("rngad_2_env_l25", append_sequence_size, max_moves,
    #                                                                              lambda_parameter=25.0)
    # environment_l50: RNGAppendDiscreteEnvironment = RNGAppendDiscreteEnvironment("rngad_2_env_l50", append_sequence_size, max_moves,
    #                                                                              lambda_parameter=50.0)
    # environment_l100: RNGAppendDiscreteEnvironment = RNGAppendDiscreteEnvironment("rngad_2_env_l100", append_sequence_size, max_moves,
    ...
    experiment_baseline_l1: RNGAppendExperiment = RNGAppendExperiment("rngad_2_exp_baseline_l1",
                                                                      validation_threshold=validation_threshold,
                                                                      test_threshold=test_threshold,
                                                                      environment=environment_l1, agent=ppo_agent)
    # experiment_baseline_l10: RNGAppendExperiment = RNGAppendExperiment("rngad_2_exp_baseline_l10",
    ...
    # experiment_baseline_l25: RNGAppendExperiment = RNGAppendExperiment("rngad_2_exp_baseline_l25",
    ...
    # experiment_baseline_l50: RNGAppendExperiment = RNGAppendExperiment("rngad_2_exp_baseline_l50",
    ...
    # experiment_baseline_l100: RNGAppendExperiment = RNGAppendExperiment("rngad_2_exp_baseline_l100",
