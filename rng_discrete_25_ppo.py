...
def run(workspace: str,
    ...
    environment_l1: RNGDiscreteEnvironment = RNGDiscreteEnvironment("rngd_25_env_l1", sequence_size, max_moves,
                                                                    lambda_parameter=1.0)
    environment_l10: RNGDiscreteEnvironment = RNGDiscreteEnvironment("rngd_25_env_l10", sequence_size, max_moves,
                                                                     lambda_parameter=10.0)
    environment_l25: RNGDiscreteEnvironment = RNGDiscreteEnvironment("rngd_25_env_l25", sequence_size, max_moves,
                                                                     lambda_parameter=25.0)
    environment_l50: RNGDiscreteEnvironment = RNGDiscreteEnvironment("rngd_25_env_l50", sequence_size, max_moves,
                                                                     lambda_parameter=50.0)
    environment_l100: RNGDiscreteEnvironment = RNGDiscreteEnvironment("rngd_25_env_l100", sequence_size, max_moves,
    ...
    experiment_baseline_l1: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_baseline_l1",
                                                                          validation_threshold=validation_threshold,
                                                                          test_threshold=test_threshold,
                                                                          environment=environment_l1,
                                                                          agent=ppo_agent)
    experiment_wander_l1: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_wander_l1",
                                                                        validation_threshold=validation_threshold,
                                                                        test_threshold=test_threshold,
                                                                        environment=environment_l1, agent=ppo_agent,
                                                                        interface=wander_interface_l1)
    experiment_baseline_l10: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_baseline_l10",
                                                                           validation_threshold=validation_threshold * 10.0,
                                                                           test_threshold=test_threshold * 10.0,
                                                                           environment=environment_l10,
                                                                           agent=ppo_agent)
    experiment_wander_l10: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_wander_l10",
                                                                         validation_threshold=validation_threshold * 10.0,
                                                                         test_threshold=test_threshold * 10.0,
                                                                         environment=environment_l10,
                                                                         agent=ppo_agent,
                                                                         interface=wander_interface_l10)
    experiment_baseline_l25: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_baseline_l25",
                                                                           validation_threshold=validation_threshold * 25.0,
                                                                           test_threshold=test_threshold * 25.0,
                                                                           environment=environment_l25,
                                                                           agent=ppo_agent)
    experiment_wander_l25: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_wander_l25",
                                                                         validation_threshold=validation_threshold * 25.0,
                                                                         test_threshold=test_threshold * 25.0,
                                                                         environment=environment_l25,
                                                                         agent=ppo_agent,
                                                                         interface=wander_interface_l25)
    experiment_baseline_l50: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_baseline_l50",
                                                                           validation_threshold=validation_threshold * 50.0,
                                                                           test_threshold=test_threshold * 50.0,
                                                                           environment=environment_l50,
                                                                           agent=ppo_agent)
    experiment_wander_l50: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_wander_l50",
                                                                         validation_threshold=validation_threshold * 50.0,
                                                                         test_threshold=test_threshold * 50.0,
                                                                         environment=environment_l50,
                                                                         agent=ppo_agent,
                                                                         interface=wander_interface_l50)
    experiment_baseline_l100: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_baseline_l100",
                                                                            validation_threshold=validation_threshold * 100.0,
                                                                            test_threshold=test_threshold * 100.0,
                                                                            environment=environment_l100,
                                                                            agent=ppo_agent)
    experiment_wander_l100: RNGDiscreteExperiment = RNGDiscreteExperiment("rngd_25_exp_wander_l100",
                                                                          validation_threshold=validation_threshold * 100.0,
                                                                          test_threshold=test_threshold * 100.0,
                                                                          environment=environment_l100,
                                                                          agent=ppo_agent,
